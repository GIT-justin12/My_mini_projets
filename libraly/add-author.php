...
<body>
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-light"> 
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="add-author.php">Ajouter auteur</a>
                    </li>
                    <li class="nav-item">
        ...
        <form action="php/add-author.php" method="post" class="shadow p-4 rounded mt-5" style="width: 90%; max-width: 50rem;">
            <h1 class="text-center pb-5 display-4 fs-3">Ajouter un nouvel auteur</h1>
            <?php
                if (isset($_GET['error'])) { ?>
            ...
            <?php } ?>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nom de l'auteur</label>
                <input type="text" class="form-control mb-3" id="exampleInputEmail1" aria-describedby="emailHelp" name="author_name">
